...
const Hero = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-20 relative w-full lg:w-10/12 over-y-scroll mt-40 md:mt-60 lg:mt-4">
      <div className="w-11/12 lg:w-6/12 text-center mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-28 font-mono">
