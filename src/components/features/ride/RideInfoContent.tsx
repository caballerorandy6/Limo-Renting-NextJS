...
/**
 * RideInfoContent - Client Component
 *
 * 🔴 IMPORTANTE: Este componente maneja toda la lógica interactiva:
 * - Estado de add-ons
 * - Estado de special instructions
 * - Guardado de datos en el store
 * - Validación y redirección
 * - Interacciones del usuario
 *
 * ✅ Guarda en el store:
 * - vehicleName, vehiclePrice, vehicleImage
...
export default function RideInfoContent({ vehicleName, vehicleId }: RideInfoContentProps) {
  ...
  const {
    ...
    setAddOnsTotal: setStoreAddOnsTotal,
    setTotalPrice: setStoreTotalPrice,
    setSpecialInstructions: setStoreSpecialInstructions,
  ...
  // Show friendly message if no valid ride data
  if (!hasValidRide) {
    return (
      <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 py-32">
        <Card className="max-w-lg mx-4 border-2 border-yellow-300 shadow-xl">
          <CardHeader className="bg-gradient-to-r from-yellow-50 to-orange-50 text-center">
          ...
          <CardContent className="pt-6 text-center">
            <p className="text-gray-700 font-sans mb-2 text-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/reservations" className="flex-1 sm:flex-none">
                <Button className="w-full bg-blue-600 hover:bg-blue-700 font-mono text-lg py-6">
                  🚗 Start New Booking
                </Button>
              </Link>
  ...
  if (!selectedVehicle) {
    return (
      <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 py-32">
        <Card className="max-w-lg mx-4 border-2 border-red-300 shadow-xl">
          <CardHeader className="bg-gradient-to-r from-red-50 to-pink-50 text-center">
            <CardTitle className="flex flex-col items-center gap-3">
