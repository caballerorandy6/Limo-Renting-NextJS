...
/**
 * RideQuoteContent - Client Component for Quote Request Page
 *
 ...
 */
export default function RideQuoteContent() {
  // Get data from store
  const { ride, distance, duration, vehicleImage, vehicleName } =
    useRideInfoStore();
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 font-sans mt-2 max-w-2xl mx-auto">
            We'll send you a detailed quote via email within 2 hours. No
            commitment required.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Our team reviews your trip details and prepares a custom
                        quote
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Trip Summary */}
            <Card className="border-2 border-gray-300 shadow-lg sticky top-40 z-10 backdrop-blur-md bg-white/95">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="font-bold text-blue-600">{distance} mi</p>
                    </div>
                    <div>
                      <p className="text-xs font-mono text-gray-500 uppercase">
                        Duration
                      </p>
                      <p className="font-bold text-blue-600">~{duration} min</p>
                    </div>
                    <div>
                      <p className="text-xs font-mono text-gray-500 uppercase">
                        Passengers
            ...
            <Card className="border-2 border-gray-300 shadow-lg">
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <h4 className="font-mono font-bold text-center">
                    {selectedVehicle?.name || vehicleName || "Luxury Vehicle"}
                  </h4>
                  {selectedVehicle && (
                    <div className="flex justify-center gap-3">
                      <div className="flex items-center gap-1 text-sm">
                        <PassengersIcon />
                        <span>{selectedVehicle.quantityPassengers}</span>
                      </div>
                      <div className="flex items-center gap-1 text-sm">
                        <BriefcaseIcon />
                        <span>{selectedVehicle.quantityBaggage}</span>
                      </div>
                    </div>
                  )}
                </div>
